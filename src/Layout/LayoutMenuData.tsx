import { Award, BadgeCheck, CalendarDays, ChefHatIcon, CircuitBoard, Codesandbox, FileArchiveIcon, FileText, LifeBuoy, LocateFixed, Mail, Map, MessageSquare, MonitorDot, PackagePlus, PictureInPicture2, PieChart, RadioTower, ScrollText, Share2, ShoppingBag, Table, Trophy, User2, UserRound } from "lucide-react";
