...
const ListView = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      //         <img src="" alt="" className="h-10 rounded-full" />
      //       </div>
      //       <div className="grow">
      //         <h6 className="mb-1">
      //           {cell.firstName} {cell.lastName}
      //         </h6>
      //         <p className="text-slate-500 dark:text-zink-200">{cell.role}</p>
      //       </div>
      //     </div>
      //   ),
      // },
      ...
      //   enableColumnFilter: false,
      //   cell: (cell: User) => <p>{cell.createdAt}ss</p>,
      // },
      {
        header: "Status",
        accessorKey: "status",
